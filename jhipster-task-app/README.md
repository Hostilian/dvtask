open power shell first and run this 
...
now you can run basic operations
...
A GitHub Actions workflow is configured to build and test the application on every push to the `main` branch. You can find the workflow configuration in `.github/workflows/ci-cd.yml`.

To use the workflow:

1. Ensure you have added your Docker Hub credentials as secrets in your GitHub repository settings:
   - DOCKER_USERNAME
   - DOCKER_PASSWORD

2. Push your changes to the `main` branch.

3. The workflow will automatically build the application, run tests, create a Docker image, and push it to Docker Hub.

### Running the Docker image

To pull and run the latest Docker image of this application:

```
docker pull yourdockerhubusername/task-manager:latest
docker run -p 8080:8080 yourdockerhubusername/task-manager:latest
```
...
To build the final jar and optimize the jhipsterTaskApp application for production, run:
