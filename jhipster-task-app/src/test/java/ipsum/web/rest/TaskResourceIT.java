...
import static com.dv.ipsum.domain.TaskAsserts.*;
import static com.dv.ipsum.web.rest.TestUtil.createUpdateProxyForBean;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.dv.ipsum.IntegrationTest;
...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().title(DEFAULT_TITLE).completed(DEFAULT_COMPLETED).dueDate(DEFAULT_DUE_DATE).description(DEFAULT_DESCRIPTION);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().title(UPDATED_TITLE).completed(UPDATED_COMPLETED).dueDate(UPDATED_DUE_DATE).description(UPDATED_DESCRIPTION);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).completed(UPDATED_COMPLETED).dueDate(UPDATED_DUE_DATE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).completed(UPDATED_COMPLETED).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).completed(UPDATED_COMPLETED).dueDate(UPDATED_DUE_DATE).description(UPDATED_DESCRIPTION);
